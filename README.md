# ShiftWallet v5.0.6 — 月収・固定費内訳アニメーション

ShiftWallet v5.0.5をベースに、ホームの月収内訳アニメーションを確認・維持し、毎月の固定費も本体タップで内訳が開閉するよう統一したv5.0.6です。
...
- 現在の月収 / 今月の月収 / 毎月の固定費は、項目そのものをタップして内訳を開閉します。
- 3項目すべて同一のWeb Animations APIによる開閉モーションを使用します。
